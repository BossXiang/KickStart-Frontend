        ...
        <div className="workContainer">
          <div className="work">
            ...
            <div className="paintGroup">
              {isVisible1 && (
                <div className="paint">
                  <img src="assets/img/blonde1.png" alt="pic" />
                </div>
              )}
              {isVisible2 && (
                <div className="paint">
                  <img src="assets/img/blonde2.png" alt="pic" />
                </div>
              )}
              {isVisible3 && (
                <div className="paint">
                  <img src="assets/img/blonde3.png" alt="pic" />
                </div>
              )}
            </div>
          </div>
          <div className="work">
            <div className="paintGroup">
              {isVisible6 && (
                <div className="paint">
                  <img src="assets/img/dog1.jpg" alt="pic" />
                </div>
              )}
              {isVisible5 && (
                <div className="paint">
                  <img src="assets/img/dog2.jpg" alt="pic" />
                </div>
              )}
              {isVisible4 && (
                <div className="paint">
                  <img src="assets/img/dog3.jpg" alt="pic" />
                </div>
              )}
            </div>
            <div className="pic">
